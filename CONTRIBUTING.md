...
3. Откройте pull request и заполните шаблон: что изменилось и зачем — это прочитают ревьюеры. В еженедельную сводку попадает только заголовок pull request'а, поэтому сформулируйте его содержательно.
