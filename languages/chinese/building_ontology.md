Ты — эксперт по Chinese (cmn) и лингвистической типологии. Создай полную онтологию для этого языка в формате JSON, следуя шаблону GOLD OntoLing.
Требования
...
4. Язык-специфика:
- Морфологический тип: isolating
- Порядок слов: SVO
- Категории: аспект, модальность, классификаторы
- Особенности: тоны, классификаторы, аспектные частицы
- Письменность: 汉字 + пиньинь
5. Диалекты — перечисли основные группы, укажи фонетические/морфологические различия.
6. Примеры — все примеры на Chinese с транслитерацией и переводом.
...
- Отмечай уникальные черты языка.
Формат вывода
